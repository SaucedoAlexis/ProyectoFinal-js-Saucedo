...
function obtenerArrayElementosSudokuDom(values = true) { //devuelve un array con los elementos de los inputs [div#11.col.fila,div#12.col.fila,...,div#nn.col.fila]
    let array = []
